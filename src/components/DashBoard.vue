<template>
  ...
  <div class="container">
    <chart :options="graphOption"></chart>
    ...
    <aside :show.sync="showChartsList" placement="left" header="选择图表" :width="350">
      <div class="col-md-12">
          <div>
            <div class="col-sm-10">
              <a href="" class="col-sm-6 chartlist-item" v-for="chart in chartsList">
                <img class="col-sm-12" src="{{chart.imageUrl}}">
                {{ chart.name }}
              </a>
            </div>
          </div>
...
<script>
  ...
  import { initGraph } from '../vuex/actions';
  import { graphOption } from '../vuex/getters';
